CSname <- "CS10"
mzMLFolder = paste0("F:/Processed MSCRT Data/mzML/",CSname)
mgfFilePath = paste0("F:/Processed MSCRT Data/mgf/",CSname)
MixedStandardsFile = "D:/R_project/AutoRtExtractor/data/Mix51.csv"
ResultPath = "F:/Processed MSCRT Data/PreliminaryRtExtractor"
BatchPreliminaryRtExtractorResult <- paste0("F:/Processed MSCRT Data/PreliminaryRtExtractor/1_PreliminaryRtExtractor_",CSname,".Rdata")
## 执行AntomatedRtExtractor
##------------------------------------------------------------------------------
s <- Sys.time()
library(AutoRtExtractor)
AutoRtExtractor:::BatchPreliminaryRtExtractor(mzMLFolder = mzMLFolder,
                            MixedStandardsFile = MixedStandardsFile,
...
# ## ReManualRTvalidator
# s <- Sys.time()
# AutomatedRtExtractorList <- AutoRtExtractor:::ReManualRTvalidator(AutomatedRtExtractorList, ReManualRTvalidatorID = c(1003,3057,5369), Intensity2 = 1000)
# save(AutomatedRtExtractorList, file = gsub("1_PreliminaryRtExtractor_", "2_ManualRTvalidator_",BatchPreliminaryRtExtractorResult))
# e <- Sys.time()
# print(e-s)
